...
const referralSteps = [
  {
    ...
    description:
      'Share your unique referral link with friends and invite them to join.',
    shortDescription: 'Share your referral link with friends',
    icon: Link2,
    illustration: '/illustrations/share-referral.avif',
    illustrationAlt: 'Share referral link',
    color: 'purple',
  },
  {
    id: 2,
    title: 'Friend joins',
    description:
      'Your friend registers on Veloop using your referral link.',
    shortDescription: 'Your friend registers using your link',
    icon: UserPlus,
    illustration: '/illustrations/invite-friends.avif',
    illustrationAlt: 'Invite friends',
    color: 'blue',
  },
  {
    id: 3,
    ...
    description:
      'Your friend completes tasks and reaches activity milestones.',
    shortDescription: 'They complete tasks and milestones',
    icon: PlayCircle,
    illustration: '/illustrations/earn-rewards.avif',
    illustrationAlt: 'Earn rewards',
    color: 'orange',
  },
  {
    id: 4,
    title: 'Earn rewards',
    description:
      'Unlock VeCoins, rewards and exciting bonuses as milestones are completed.',
    shortDescription: 'You earn VeCoins, rewards and more!',
    icon: Gift,
    illustration: '/illustrations/refer-earn.avif',
    illustrationAlt: 'Refer and earn rewards',
    color: 'green',
  },
];
...
function ReferralJourneyModal({ isOpen, onClose }) {
  const [copied, setCopied] = useState(false);

  const referralLink = 'https://veloop.app/ref/your-code';
        ...
        >
          ...
          >
            ...
            <div className={styles.referralBox}>
              <div className={styles.referralBoxHeader}>
                <div className={styles.referralBoxIcon}>
                  <Share2 size={18} />
                </div>
            ...
            <div className={styles.rewardInfo}>
              <div className={styles.rewardInfoIcon}>
                <Trophy size={22} />
              </div>
      ...
      >
        ...
        <div className={styles.sectionHeader}>
          <div className={styles.headingArea}>
            ...
            >
              <div
                className={styles.journeyIllustrationGlow}
                aria-hidden="true"
              />

              <img
                src="/illustrations/unlock-rewards.avif"
                alt="Unlock rewards"
                ...
                >
                  ...
                  <div
                    className={`${styles.iconCard} ${
                      styles[`card${step.color}`]
                    }`}
                  >
                    <div
                      className={styles.stepIllustrationGlow}
                      aria-hidden="true"
                    />
