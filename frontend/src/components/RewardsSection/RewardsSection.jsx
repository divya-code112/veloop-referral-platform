...
function RewardMilestone({
  ...
  const getCoinValue = () => {
    if (reward.amount) return reward.amount;
    if (reward.points) return reward.points;
    if (reward.value) return reward.value;
    if (reward.coinValue) return reward.coinValue;
  ...
  return (
    <div className={styles.milestoneWrapper}>
      ...
      {index < total - 1 && (
        ...
        >
          <div className={styles.connectionGlow} />
        </div>
      )}
...
function RewardDetailCard({
  ...
  const getStatus = () => {
    ...
    if (isActive) return 'Ready to Claim';
      ...
      >
        ...
        <div className={styles.headerLayout}>
          ...
          <div className={styles.topBar}>
            ...
            <div className={styles.heading}>
              ...
              <div>
                ...
                <p>
                  Unlock bigger rewards as you refer
                  more friends
                </p>
              </div>
          ...
          >
            ...
            <img
              src="/illustrations/spin-wheel.avif"
              alt="Spin wheel rewards"
          ...
          >
            ...
            >
              ...
              <div className={styles.modalHeader}>
                ...
                <div className={styles.modalHeading}>
                  ...
                  <div>
                    ...
                    <p>
                      Complete milestones and unlock
                      exciting rewards
                    </p>
              ...
              <div className={styles.modalFooter}>
                ...
                <span>
                  Keep referring friends to unlock
                  more rewards!
                </span>
