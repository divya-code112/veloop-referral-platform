...
export const walletTransactions = [
  {
    ...
    description: 'Your friend successfully joined VELoop',
    amount: 500,
    type: 'credit',
    category: 'referral',
    date: 'Today, 10:30 AM',
...

  {
    ...
    description: 'Completed your 5 referral milestone',
    amount: 1000,
    type: 'credit',
    category: 'milestone',
    date: 'Yesterday',
...

  {
    id: 3,
    title: 'Task Reward',
    description: 'Reward earned for completing a task',
    amount: 150,
    type: 'credit',
    category: 'task',
    date: 'Sep 06, 2026',
...

  {
    id: 5,
    title: 'Referral Reward',
    description: 'Referral reward is being processed',
    amount: 350,
    type: 'pending',
    category: 'referral',
    date: 'Sep 02, 2026',
